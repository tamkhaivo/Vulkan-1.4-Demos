...
struct PushConstants {
    vk_math::Mat4 mvp;
    Vec4 latencyIndicator; // rgb: color, a: ping indicator
};

// Generate 3D Prism Geometry
...
int main() {
    ...
    std::cout << " Concepts: VK_NV_low_latency2, Latency Sleep & Frame Pacing,\n";
    std::cout << "           Click-to-Photon Telemetry & Dynamic Rendering\n";
    std::cout << "========================================================\n";
    ...
    try {
        ...
        GLFWwindow* window = vulkan_utils::createWindow(WIDTH, HEIGHT, "Assignment 49: Low Latency Frame Pacing (Vulkan 1.4)");
        ...
        // Shaders
        auto vertCode = vulkan_utils::readFile("shaders/low_latency.vert.spv");
        auto fragCode = vulkan_utils::readFile("shaders/low_latency.frag.spv");
        ...
        std::cout << "[Render Loop] Running Low Latency Swapchain Timing Frame Loop...\n";
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            // Orbiting scene
            vk_math::Mat4 model = vk_math::Mat4::rotate(time * 1.1f, vk_math::Vec3(0.5f, 1.0f, 0.0f)) *
        ...
        std::cout << "\nAssignment 49 executed cleanly (" << frameCount << " low latency frames rendered).\n";
    } catch (const std::exception& e) {
        std::cerr << "Assignment 49 Error: " << e.what() << "\n";
        return 1;
    }
