...
// Concepts:
//   - VK_KHR_video_queue & VK_KHR_video_decode_av1
//   - Zero-Copy Bitstream Decoding & YCbCr Sampler Conversion
...
void generateScreenGeometry(std::vector<Vertex>& vertices, std::vector<uint16_t>& indices) {
...
int main() {
    std::cout << "====================================================================\n";
    std::cout << " Assignment 81: Zero-Copy AV1 Hardware Video Decode (Vulkan 1.4)\n";
    std::cout << " Compiled with Clang 17+ Standard | Targeting VK_API_VERSION_1_4\n";
    std::cout << " Concepts: VK_KHR_video_decode_av1, Hardware AV1 Bitstream Queue,\n";
    std::cout << "           YCbCr BT.709 Direct Conversion & Dynamic Rendering\n";
    std::cout << "====================================================================\n";
    ...
    try {
        ...
        GLFWwindow* window = vulkan_utils::createWindow(WIDTH, HEIGHT, "Assignment 81: AV1 Video Hardware Decode (Vulkan 1.4)");
        ...
        generateScreenGeometry(vertices, indices);
        ...
        // Shaders
        std::string shaderDir = "assignment81_av1_video_decode_ycbcr/shaders/";
        if (!std::filesystem::exists(shaderDir + "av1_video.vert.spv")) shaderDir = "shaders/";

        auto vertCode = vulkan_utils::readFile(shaderDir + "av1_video.vert.spv");
        auto fragCode = vulkan_utils::readFile(shaderDir + "av1_video.frag.spv");
        ...
        std::cout << "[AV1 Video Decoder] Initialized hardware decode session with DPB surfaces.\n";
        std::cout << "[Render Loop] Executing AV1 Video Playback and YCbCr Surface Render Loop...\n";
        ...
        while (!glfwWindowShouldClose(window) && frameCount < 400) {
            ...
            // Dynamic layout transitions using Synchronization2
            ...
            pc.videoTime = Vec4(time, 0.0f, 0.0f, 0.0f);
        ...
        std::cout << "\nAssignment 81 executed cleanly (400 frames rendered).\n";
    }
