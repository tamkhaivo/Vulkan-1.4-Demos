...
int main() {
    ...
    try {
        ...
        // Initialize Flame Graph Profiler for assignment20_sparse_virtual_texturing
        auto& profiler = vk_profiler::FlameGraphProfiler::get();
        profiler.setSessionName("assignment20_sparse_virtual_texturing");
        profiler.initGpu(device, physicalDevice);



        while (!glfwWindowShouldClose(window)) {
            VK_PROFILE_SCOPE("assignment20_sparse_virtual_texturing");
            glfwPollEvents();
        ...
        profiler.exportFoldedFile("flamegraph_assignment20_sparse_virtual_texturing.folded");
        profiler.exportInteractiveHTML("flamegraph_assignment20_sparse_virtual_texturing.html");
        profiler.exportChromeTraceFile("flamegraph_assignment20_sparse_virtual_texturing.json");
        profiler.cleanupGpu();
