// ============================================================================
// Assignment 44: External Memory Interop & CUDA/D3D12 Synchronization
// Standardized for Clang 17+ Compiler & Vulkan 1.4 Specification
// Concepts:
//   - VK_KHR_external_memory_win32 & VK_KHR_external_semaphore_win32
//   - VkExportMemoryAllocateInfo & Windows NT Shared Handles
//   - Zero-Copy Cross-API GPU Memory Streaming & Dynamic Rendering
// ============================================================================
...
int main() {
    ...
    std::cout << " Concepts: VK_KHR_external_memory, Shared Windows NT Handles,\n";
    std::cout << "           Zero-Copy Interop Architecture, Dynamic Rendering\n";
    std::cout << "========================================================\n";
    ...
    try {
        ...
        GLFWwindow* window = vulkan_utils::createWindow(WIDTH, HEIGHT, "Assignment 44: External Memory Interop (Vulkan 1.4)");
        ...
        // Shaders
        auto vertCode = vulkan_utils::readFile("shaders/interop_scene.vert.spv");
        auto fragCode = vulkan_utils::readFile("shaders/interop_scene.frag.spv");
        ...
        std::cout << "[Render Loop] Rendering Shared Interop Geometry...\n";

        auto startTime = std::chrono::high_resolution_clock::now();
        uint64_t frameCount = 0;

        
        // Initialize Flame Graph Profiler for assignment44_external_memory_interop
        auto& profiler = vk_profiler::FlameGraphProfiler::get();
        profiler.setSessionName("assignment44_external_memory_interop");
        profiler.initGpu(device, physicalDevice);



        while (!glfwWindowShouldClose(window)) {
            VK_PROFILE_SCOPE("assignment44_external_memory_interop");
            glfwPollEvents();
        ...
        profiler.exportFoldedFile("flamegraph_assignment44_external_memory_interop.folded");
        profiler.exportInteractiveHTML("flamegraph_assignment44_external_memory_interop.html");
        profiler.exportChromeTraceFile("flamegraph_assignment44_external_memory_interop.json");
        profiler.cleanupGpu();
        ...
        std::cout << "\nAssignment 44 executed cleanly (" << frameCount << " frames rendered).\n";
