...
// Concepts:
//   - VK_KHR_fragment_shading_rate & Saliency Rate Maps
//   - Dynamic Attachment Fragment Shading Rate (VkRenderingFragmentShadingRateAttachmentInfoKHR)
//   - Dynamic Rendering with Depth Testing & Foveated Shading Optimization
// ============================================================================
...
int main() {
    std::cout << "========================================================\n";
    std::cout << " Assignment 55: Saliency Shading Rate Maps (Vulkan 1.4)\n";
    std::cout << " Compiled with Clang 17+ Standard | Targeting VK_API_VERSION_1_4\n";
    std::cout << " Concepts: VK_KHR_fragment_shading_rate, Saliency Rate Images,\n";
    std::cout << "           Dynamic Foveated Shading, Dynamic Rendering\n";
    std::cout << "========================================================\n";
    ...
    try {
        ...
        GLFWwindow* window = vulkan_utils::createWindow(WIDTH, HEIGHT, "Assignment 55: Saliency Shading Rate Maps (Vulkan 1.4)");
        ...
        // Shaders
        auto vertCode = vulkan_utils::readFile("shaders/saliency_scene.vert.spv");
        auto fragCode = vulkan_utils::readFile("shaders/saliency_scene.frag.spv");
        ...
        std::cout << "[Render Loop] Rendering with Saliency Shading Rate Maps (VK_KHR_fragment_shading_rate)...\n";

        auto startTime = std::chrono::high_resolution_clock::now();
        uint64_t frameCount = 0;

        
        // Initialize Flame Graph Profiler for assignment55_saliency_shading_rate_maps
        auto& profiler = vk_profiler::FlameGraphProfiler::get();
        profiler.setSessionName("assignment55_saliency_shading_rate_maps");
        profiler.initGpu(device, physicalDevice);



        while (!glfwWindowShouldClose(window)) {
            VK_PROFILE_SCOPE("assignment55_saliency_shading_rate_maps");
            glfwPollEvents();
        ...
        profiler.exportFoldedFile("flamegraph_assignment55_saliency_shading_rate_maps.folded");
        profiler.exportInteractiveHTML("flamegraph_assignment55_saliency_shading_rate_maps.html");
        profiler.exportChromeTraceFile("flamegraph_assignment55_saliency_shading_rate_maps.json");
        profiler.cleanupGpu();
        ...
        std::cout << "\nAssignment 55 executed cleanly (" << frameCount << " frames rendered).\n";
    } catch (const std::exception& e) {
        std::cerr << "Assignment 55 Error: " << e.what() << "\n";
        return 1;
    }
