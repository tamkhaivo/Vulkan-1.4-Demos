...
int main() {
    ...
    std::cout << "Concepts: Uniform Buffers, Descriptor Sets, Vulkan 1.4 Dynamic Rendering" << std::endl;
    std::cout << "========================================================" << std::endl;

    try {
        GLFWwindow* window = vulkan_utils::createWindow(800, 600, "Assignment 2: Rotating Cube (Vulkan 1.4)");
        ...
        std::cout << "Vulkan 1.4 Logical Device initialized for Assignment 2." << std::endl;
    ...
    std::cout << "Assignment 2 initialized cleanly under Vulkan 1.4 standard." << std::endl;
    return EXIT_SUCCESS;
}
