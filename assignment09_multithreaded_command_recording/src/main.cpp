...
int main() {
    ...
    try {
        GLFWwindow* window = vulkan_utils::createWindow(800, 600, "Assignment 9: Multi-Threaded Recording (Vulkan 1.4)");
    ...
    std::cout << "Assignment 9 initialized cleanly under Vulkan 1.4 standard." << std::endl;
    return EXIT_SUCCESS;
}
