...
int main() {
    ...
    std::cout << "Concepts: Instanced Draw Calls, Per-Instance Attributes, Vulkan 1.4 Core Features" << std::endl;
    std::cout << "========================================================" << std::endl;

    try {
        GLFWwindow* window = vulkan_utils::createWindow(800, 600, "Assignment 5: Instanced Rendering (Vulkan 1.4)");
        ...
        std::cout << "Vulkan 1.4 Logical Device initialized for Assignment 5." << std::endl;
    ...
    std::cout << "Assignment 5 initialized cleanly under Vulkan 1.4 standard." << std::endl;
    return EXIT_SUCCESS;
}
